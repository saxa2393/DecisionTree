...
public class FlowTest {
    ...
    public static void main(String[] args) {
        ...
        Feature<Integer> f1 = new Feature<>(AGE, 35, Feature.Type.CONTINUOUS);
        Feature<Integer> f2 = new Feature<>(SALARY, 100_816, Feature.Type.CONTINUOUS);
        Feature<String> f3 = new Feature<>(SEX, "male", Feature.Type.DISCRETE);
        Record<String> r1 = new Record<>(Arrays.asList(f1, f2, f3), null);

        System.out.println(dt.predict(r1));
    }

    /**
     * Creates test Records for the DecisionTree.
     * @return Test Records for the DecisionTree.
     */
